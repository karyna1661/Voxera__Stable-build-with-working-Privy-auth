...
export const mockDemoVideos: DemoVideo[] = [
  ...
  },
  {
    ...
    description: 'IoT-powered system that learns your habits and automatically optimizes energy consumption to reduce bills by up to 40%.',
  ...
  },
  {
    ...
    description: 'Blockchain-based education platform where learners earn tokens for completing courses and can stake them for premium content.',
    ...
    category: 'Education',
    tags: ['Blockchain', 'Education', 'DeFi'],
    responseCount: 67,
    resonanceScore: 93,
    feedbackVaultId: 'vault-demo-5',
    allowAnonymous: true,
    enableTips: true
  },
  {
    id: 'demo-6',
    title: 'AR Food Nutrition Scanner',
    description: 'Point your phone at any food item and instantly see detailed nutritional information, allergen warnings, and personalized health recommendations.',
    ...
    category: 'Health & Wellness',
    tags: ['AR', 'Health', 'Nutrition'],
    responseCount: 38,
    resonanceScore: 91,
    feedbackVaultId: 'vault-demo-6',
    allowAnonymous: true,
    enableTips: true
  },
  {
    id: 'demo-7',
    title: 'Voice-Controlled Investment Assistant',
    description: 'AI-powered investment platform that lets you manage your portfolio, execute trades, and get market insights using natural voice commands.',
    ...
    category: 'Finance',
    tags: ['AI', 'Finance', 'Voice UI'],
    responseCount: 54,
    resonanceScore: 96,
    feedbackVaultId: 'vault-demo-7',
    allowAnonymous: true,
    enableTips: true
  },
  {
    id: 'demo-8',
    title: 'Collaborative Music Creation Studio',
    description: 'Web3 platform where musicians worldwide can collaborate in real-time, share royalties automatically, and mint their creations as NFTs.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    ...
    tags: ['Music', 'Web3', 'Collaboration'],
    responseCount: 73,
    resonanceScore: 89,
    feedbackVaultId: 'vault-demo-8',
    allowAnonymous: true,
    enableTips: true
  }
];
...
export const mockFeedbackVaults: FeedbackVault[] = [
  ...
  {
    id: 'vault-demo-3',
    title: 'Mental Health Support App Feedback',
    description: 'Voice feedback for the mental health demo',
    type: 'demo',
    demoVideoId: 'demo-3',
    creator: mockUsers[2],
    createdAt: '2024-01-13T09:20:00Z',
  ...
  {
    id: 'vault-demo-4',
    title: 'Smart Home Energy Optimizer Feedback',
    description: 'Voice feedback for the smart home energy demo',
    type: 'demo',
    demoVideoId: 'demo-4',
    creator: mockUsers[3],
    createdAt: '2024-01-12T14:15:00Z',
  ...
  {
    id: 'vault-demo-5',
    title: 'Decentralized Learning Platform Feedback',
    description: 'Voice feedback for the decentralized learning demo',
    type: 'demo',
    demoVideoId: 'demo-5',
    creator: mockUsers[4],
    createdAt: '2024-01-11T16:30:00Z',
  ...
  {
    id: 'vault-demo-6',
    title: 'AR Food Nutrition Scanner Feedback',
    description: 'Voice feedback for the AR nutrition scanner demo',
    type: 'demo',
    demoVideoId: 'demo-6',
    creator: mockUsers[0],
    createdAt: '2024-01-10T11:45:00Z',
  ...
  {
    id: 'vault-demo-7',
    title: 'Voice-Controlled Investment Assistant Feedback',
    description: 'Voice feedback for the investment assistant demo',
    type: 'demo',
    demoVideoId: 'demo-7',
    creator: mockUsers[1],
    createdAt: '2024-01-09T13:20:00Z',
  ...
  {
    id: 'vault-demo-8',
    title: 'Collaborative Music Creation Studio Feedback',
    description: 'Voice feedback for the music creation demo',
    type: 'demo',
    demoVideoId: 'demo-8',
    creator: mockUsers[2],
    createdAt: '2024-01-08T10:00:00Z',
